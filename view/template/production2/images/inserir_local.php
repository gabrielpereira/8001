...
if(isset($_POST["action"])){
    switch($_POST["action"]){
        case "inserir":
            ...
            $mensagem = $localController->inserirLocal($_POST["cod"], $_POST["nome"], $_POST["cidade"], $_POST["posicao_global"]);
    }
}
?>
<!DOCTYPE html>
                            ...
                            <div class="x_content">
                                ...
                                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="cod" name="cod" required="required" class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="cidade" name="cod" required="required" class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
									<div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Latitude e Longitude <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="posicao_global" name="cod" required="required" class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
