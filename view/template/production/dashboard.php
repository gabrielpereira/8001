...
require_once("../../../controller/AnoController.php");


$AnoController = AnoController::getInstance();
$locais = $AnoController->getAnoPor("id");
?>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>				Bem vindo Administrador,<br>
				Por favor escolha nas abas na esquerda a funcao que voce deseja.</h3>
              </div>
              </div>
            ...
            <div class="row">
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h3>Vendas de bilhete feita em cada mês do ano. <small></small></h>
...
<li><a href="cliente2.php">Historico Clientes</a></li>
                  </div>
                </div>
              </div>
