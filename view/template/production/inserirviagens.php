...
$MotoristaController = MotoristaController::getInstance();
$locais = $MotoristaController->getMotoristaPor("cpf");
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Motorista da nossa companhia. <small></small></h2>
            ...
            ?>
               ...
               <form method = "post" action = "<?php $_PHP_SELF ?>">
                  <table width = "400" border = "0" cellspacing = "1" 
                     cellpadding = "2">
					<h3>Escolha o cpf_motorista para está viagem :</h3>
					             <tr>
